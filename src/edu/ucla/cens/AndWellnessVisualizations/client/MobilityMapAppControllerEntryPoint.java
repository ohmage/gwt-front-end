...
public class MobilityMapAppControllerEntryPoint implements EntryPoint {
    ...
    public void onModuleLoad() {
        ...
        MobilityMapAppController appController = new MobilityMapAppController(rpcService, eventBus, loginManager);
        appController.go();
    }
}
