...
import org.ohmage.mobilize.client.utils.InputValidationUtils;

public class LoginSelfRegistration extends Composite {

  private static LoginSelfRegistrationUiBinder uiBinder = GWT.create(LoginSelfRegistrationUiBinder.class);
