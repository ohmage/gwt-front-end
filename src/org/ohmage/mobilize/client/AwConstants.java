...
public class AwConstants {
  ...
  /**
   * Returns data server url based on value of deployment status variable. This
   * setup is useful because you can set your build script to use different
   * module files for debug vs release instead of trying to remember to change
   * the server location every time you deploy.
   *
