...
import org.ohmage.mobilize.client.ui.MobilityVizDailySummary;
import org.ohmage.mobilize.client.ui.MobilityVizHistoricalAnalysis;
import org.ohmage.mobilize.client.ui.MobilityWidgetPopup;
import org.ohmage.mobilize.client.ui.ResponseWidgetPopup;
import org.ohmage.mobilize.client.utils.DateUtils;
import org.ohmage.mobilize.client.utils.MapUtils;
import org.ohmage.mobilize.client.utils.MarkerClusterer;
import org.ohmage.mobilize.client.utils.MobilityUtils;

@SuppressWarnings("deprecation")
public class ExploreDataViewImpl extends Composite implements ExploreDataView {

    private static ExploreDataViewUiBinder uiBinder = GWT.create(ExploreDataViewUiBinder.class);
    ...
    Tree plotTypeTree;
    @UiField
    CaptionPanel dataControls;
    @UiField
    Label requiredFieldMissingMsg;
    @UiField
    Label campaignLabel;
    @UiField
    Label surveyLabel;
    ...
    Label endDateLabel;
    @UiField
    ListBox campaignListBox;
    @UiField
    ListBox surveyListBox;
    @UiField
    ListBox classListBox;
    @UiField
    ListBox participantListBox;
    @UiField
    ListBox promptXListBox;
    @UiField
    ListBox promptYListBox;
    @UiField
    DateBox dateStartBox;
    @UiField
    DateBox dateEndBox;
    @UiField
    Button drawPlotButton;
    //@UiField Button pdfButton;
    @UiField
    Button exportButton;
    @UiField
    HTMLPanel hiddenFormContainer;
    @UiField
    FlowPanel plotContainer;
    ...
    private TreeItem getTreeItem(String text, PlotType plotType, String cssStyle) {
        ...
        if (plotType != null) {
            treeItem.setUserObject(plotType);
        }
        return treeItem;
    }
    ...
    private void loadPlotTypeTree() {
        /*
         * NOTE(8/4/2011): plotType enum is converted to all lowercase and
         * becomes the plot type argument in the api call. So
         * SURVEY_RESPONSE_COUNT becomes
         * "/app/viz/survey_response_count/read..." (See
         * OhmageDataService.getVisualizationUrl()) NOTE(8/27/2011):
         * LEADER_BOARD is a special case that does not query the api
         */
    ...
    public String getSelectedParticipant() {
        if (!participantListBox.isEnabled()) {
            return null;
        }
    ...
    /*
     * Returns true if a promptId is disabled in a listBox, false otherwise or
     * invalid
     */
    ...
    public void setEndDateRangeEnabled(boolean isEnabled) {
        ...
        if (isEnabled == false) {
            /*
             * 01/06/2012: temporary fix. explore data controls will be
             * overhauled in next release
             */
            startDateLabel.setText("Date:");
        } else {
            //01/06/2012: see note above
    ...
    /*
     * @Override public HasClickHandlers getPdfButton() { return pdfButton; }
     */
    @Override
    ...
    private void setResponsesOnMap(List<SurveyResponse> responses) {
        ...
        if (!mapWidget.isAttached()) {
            plotContainer.add(mapWidget);
        }
    ...
    private void initMap(final Runnable actionToTakeWhenDone) {
        ...
        if (actionToTakeWhenDone != null) {
            actionToTakeWhenDone.run();
        }
    }
