...
<jsp:include page="/jsp/header.jsp"/>
		...
		<div id="contents">
			    ...
			    Mark Hansen, Deborah Estrin, WirelessHealth'10, October 2010 [<a href="http://lecs.cs.ucla.edu/~jhicks/pubs/wireless-health.pdf">PDF</a>]</p>
			
				<h3>Proposals</h3>
			
				<h3>Inspirations and Various Related Work</h3>
